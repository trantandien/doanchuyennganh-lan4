...
<div style="background: white;border: 5px solid grey;padding: 10px 0px;position: absolute;top: 315px;left: 130px;line-height: 30px"><div style="border-bottom: 5px solid grey;padding-bottom: 10px"><h2 align="center">Thông Báo</h2></div>
<form action="index.php" >
  <table style="border: none;width: 1350px;">
    <tr>
...
<form action="index.php">
  <table style="border: none;margin-left: 150px;width: 300px">
    <tr>
