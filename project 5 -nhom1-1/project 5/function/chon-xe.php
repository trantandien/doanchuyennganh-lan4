...
<br><div><a style="font-size: 25px;margin-left: 800px">CHUYẾN XE HIỆN CÓ</a></div><br>
...
<form method="post" action="thanh-toan.php">
    ...
    <!-- <input type="text" name="idchuyen" value="<?php //echo $chonxe['idchuyen'] ?>">  lay id chuyen do ra-->
    </td>
    ...
    <!-- <a href="bovao.php?idsp=<?php //echo $chonxe['idchuyen']; ?>"><button type="button" name="btnCart" style="color: white;height: 30px;width: 100px;font-weight: bolder;margin-left: 20px;">THÊM</button></a> -->
