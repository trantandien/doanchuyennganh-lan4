...
<div id="main">
  ...
  <div id="body">
  <div class="slideshow-container" style="width: all;height: 480px">
<div class="mySlides fade">
<img src="image/1.jpg" width="100%" height="480">
</div>
<div class="mySlides fade">
<img src="image/2.jpg" width="100%" height="480">
</div>
<div class="mySlides fade">
<img src="image/3.jpg" width="100%" height="480">
</div>
<div class="mySlides fade">
<img src="image/4.jpg" width="100%" height="480">
</div>
<div class="mySlides fade">
<img src="image/5.jpg" width="100%" height="480">
</div>
...
<div>
  ...
  <div id="form" style="position: absolute;top:40px;background-color: white;width: 380px;left: 120px;height: 300px;opacity: 0.6;">.
  </div>
    <table style="border: none;position: absolute;top:40px;font-weight: bold;opacity: 9.0;">
      <tr>
        <!-- <td style="font-size: 15px">
          <input id="trip0" type="radio" name="trip" value="0" checked=""> Vé một chiều
        </td> -->
        <td colspan="" style="font-size: 20px">
          <input id="trip1" type="radio" name="trip" value="1" checked=""> Tìm Vé Xe
        </td>
      </tr>
      <tr>
        <td><img width="20" align="center" src="image/local.png" > Nơi đi </td>
        <td colspan="" style="font-size: 20px;height: 50px;" ><select name="noi-di" style="height:30px" >
        </select></td>
      </tr>
      <br>  
      <tr>
        <td><img width="20" align="center" src="image/local.png"> Nơi đến </td>
        <td colspan=""><select name="noi-den" style="height:30px">
        </select>
        </td>
      </tr>
      ...
      <!-- <tr id="ngayve"></tr> -->
      <tr>
        <td colspan="2"><button type="submit" style="border: none;background-color: #FF8000;width: 150px;height: 40px;margin-right: 15px;float: right;border-radius: 0 10px 10px 0;font-size: 17px"><b>TÌM VÉ</b></button><button id="bnt" type="submit" style="border: none;background-color: #F5D0A9;width: 50px;height: 40px;float: right;border-radius: 10px 0 0 10px;"><img align="center" width="20" src="image/search.png"></button></td>
      </tr>
    </table>
  </form>
  <table>
